...
func (client Client) getParams(ep EndPoint, signType SignType, kwargs map[string]interface{}) map[string]interface{} {
	...
	if signType == SIMPLE {
		...
		panic("unknown sign type" + string(signType))
	}
	return params
}
...
func (client Client) getBaseRes(method string, endpoint EndPoint, params map[string]interface{}) (jsonRes, error) {
	var r *http.Response
	var err error
	if method == "GET" {
